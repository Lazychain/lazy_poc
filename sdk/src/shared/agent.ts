import type { AgentConfig } from "@hyperlane-xyz/sdk";
...
import type { ContextHook } from "./context";
...
export async function fromContext(
  ...
  //logger.info.log('Calling getContractInfo function');
  ...
  logger.info(`OK ${JSON.stringify(mailboxContractInfo, null, "\t")}`);
...
export async function saveAgentConfig(
  ...
  fs.writeFileSync(fileName, JSON.stringify(agentConfig, null, "\t"));
  return agentConfig;
}
